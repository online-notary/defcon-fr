                            ...
                            <div className="image_block_1">
                                <div className="image-box">
                                    <div className="shape-box">
                                        <div className="line line-1" style={{ backgroundImage: "url(assets/images/icons/line-1.png)" }}></div>
                                        <div className="line line-2" style={{ backgroundImage: "url(assets/images/icons/line-2.png)" }}></div>
                                        <div className="line line-3" style={{ backgroundImage: "url(assets/images/icons/line-3.png)" }}></div>
                            ...
                            <div className="content_block_1">
                                <div className="content-box">
                                    ...
                                    <div className="lower-content clearfix">
                                        <h4>“Security is everyone's concern but <br />it's our business.”</h4>
                                        <div className="btn-box"><Link href="/about" className="theme-btn style-one">Read More</Link></div>
                                    </div>
                                </div>
                            </div>
                        </div>
