    ...
    return (
        <> 
            ...
            <section className="estimation-section">
                <div className="bg-layer" style={{ backgroundImage: "url(assets/images/background/estimation-bg.jpg)" }}></div>
                    ...
                    <div className="sec-title centred light">
                        <div className="top-title">
                            <div className="shape">
                                ...
                                <div className="bg-shape" style={{ backgroundImage: "url(assets/images/icons/bg-shape-4.png)" }}></div>
                            </div>
                            <p>Free Estimation</p>
                        </div>
                        <h2>All our estimates are given without <br />any fee or obligation</h2>
                    </div>
