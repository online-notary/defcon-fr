    ...
    return (
        <> 
            ...
            <section className="contact-section sec-pad">
                ...
                <figure className="image-layer wow slideInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms"><img src="assets/images/resource/contact-1.png" alt=""/></figure>
                    ...
                    <div className="row clearfix">
                        <div className="col-lg-4 col-md-12 col-sm-12 content-column">
                            <div className="content_block_7">
                                <div className="content-box">
                                    ...
                                    <div className="text">
                                        <p>Must explain to you how all this mistaken idea of denouncing pleasure & praising.</p>
                                    </div>
                                    <div className="support-box">
                                        <i className="icon-dial-pad"></i>
                                        <p>Make a Call</p>
                                        <h3><Link href="tel:15417543010">+1-541-754-3010</Link></h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-8 col-md-12 col-sm-12 content-column">
                            <div className="content_block_8">
                                <div className="content-box">
                                    <form action="/contact" method="post" className="default-form">
                                        <div className="row clearfix">
