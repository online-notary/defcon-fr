                ...
                <div className="auto-container">
                        ...
                        <div className="row clearfix">
                                ...
                                <div className="footer-widget contact-widget">
                                    ...
                                    <div className="widget-content">
                                        ...
                                        <ul className="social-style-two clearfix">
                                            ...
                                            <li><Link href="/index-3"><i className="fab fa-youtube"></i></Link></li>
                                ...
                                <div className="footer-widget links-widget">
                                    ...
                                    <div className="widget-content">
                                        <ul className="links-list clearfix">
                                            ...
                                            <li><Link href="/index-3">Our Services</Link></li>
                                            <li><Link href="/index-3">Projects</Link></li>
                                            <li><Link href="/index-3">Industries</Link></li>
                                            <li><Link href="/index-3">Pricing & Plans</Link></li>
                                            <li><Link href="/index-3">Bodyguards</Link></li>
                                            <li><Link href="/index-3">Why Choose Us</Link></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            <div className="col-lg-3 col-md-6 col-sm-12 footer-column">
                                <div className="footer-widget links-widget">
                                    ...
                                    <div className="widget-content">
                                        <ul className="links-list clearfix">
                                            <li><Link href="/index-3">Get Free Quote</Link></li>
                                            <li><Link href="/index-3">News & Updates</Link></li>
                                            <li><Link href="/index-3">Private Policies</Link></li>
                                            <li><Link href="/index-3">Monitoring</Link></li>
                                            <li><Link href="/index-3">FAQ’s</Link></li>
                                            <li><Link href="/index-3">Testimonials</Link></li>
                                            <li><Link href="/index-3">Get in Touch</Link></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="footer-bottom-three clearfix">
                        <div className="copyright pull-left">
                            <p>&copy; {new Date().getFullYear()} <Link href="/index-3">Blackcats</Link>, All Rights Reserved.</p>
                        </div>
                        <ul className="footer-nav pull-right clearfix">
                            ...
                            <li><Link href="/index-3">Site Map</Link></li>
                        </ul>
                    </div>
                </div>
            </footer>
