                    ...
                    <div className="footer-top-four">
                        <div className="upper-inner clearfix">
                            <div className="footer-logo pull-left">
                                <figure className="logo"><Link href="/index-4"><img src="assets/images/footer-logo-2.png" alt=""/></Link></figure>
                            </div>
                            <ul className="social-style-two clearfix pull-right">
                                ...
                                <li><Link href="/index-4"><i className="fab fa-youtube"></i></Link></li>
                                ...
                                <div className="col-lg-3 col-md-6 col-sm-12 footer-column">
                                    <div className="footer-widget links-widget">
                                        <ul className="links-list clearfix">
                                            <li><Link href="/index-4">About Company</Link></li>
                                            <li><Link href="/index-4">Leadership</Link></li>
                                            <li><Link href="/index-4">Blog Post</Link></li>
                                            <li><Link href="/index-4">FAQ’s</Link></li>
                                            <li><Link href="/index-4">Certification</Link></li>
                                            <li><Link href="/index-4">Testimonials</Link></li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div className="auto-container">
                        <div className="bottom-inner clearfix">
                            <div className="copyright pull-left">
                                <p>&copy; {new Date().getFullYear()} <Link href="/index-4">Blackcats</Link>, All Rights Reserved.</p>
                            </div>
                            <ul className="footer-nav pull-right clearfix">
                                ...
                                <li><Link href="/index-4">Site Map</Link></li>
                            </ul>
                        </div>
                    </div>
                </div>
