                        ...
                        <div className="row clearfix">
                            <div className="col-lg-4 col-md-6 col-sm-12 footer-column">
                                <div className="footer-widget logo-widget">
                                    <figure className="footer-logo"><Link href="/index-6"><img src="assets/images/footer-logo-4.png" alt=""/></Link></figure>
                                    <div className="widget-content">
                                        ...
                                        <div className="link"><Link href="/index-6">Read more<i className="fas fa-angle-right"></i></Link></div>
                                    </div>
                                </div>
                            </div>
                            <div className="col-lg-4 col-md-6 col-sm-12 footer-column">
                                <div className="footer-widget post-widget">
                                    ...
                                    <div className="post-inner">
                                        <div className="post">
                                            ...
                                            <h6><Link href="blog-details.html">5 Ways CCTV Can Improve Security of Your House</Link></h6>
                                        ...
                                        <div className="post">
                                            ...
                                            <h6><Link href="blog-details.html">Reasons Why it is Important to install CCTV</Link></h6>
                            ...
                            <div className="col-lg-4 col-md-6 col-sm-12 footer-column">
                                <div className="footer-widget contact-widget">
                                    ...
                                    <ul className="social-style-two clearfix">
                                        ...
                                        <li><Link href="/index-6"><i className="fab fa-youtube"></i></Link></li>
                    ...
                    <div className="auto-container">
                        <div className="bottom-inner clearfix">
                            <div className="copyright pull-left">
                                <p>&copy; {new Date().getFullYear()} <Link href="/index-6">Blackcats</Link>, All Rights Reserved.</p>
                            </div>
