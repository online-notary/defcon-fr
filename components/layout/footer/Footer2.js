                  ...
                  <div className="footer-widget logo-widget">
                    ...
                    <div className="text">
                      <p>
                        ...
                        distract by readable content of a page when looking at
                  ...
                  <div className="footer-widget links-widget">
                    ...
                    <div className="widget-content clearfix">
                      <ul className="list">
                        ...
                        <li>
                          <Link href="/index-2">Our Services</Link>
                        </li>
                        <li>
                          <Link href="/index-2">Projects</Link>
                        </li>
                        <li>
                          <Link href="/index-2">Industries</Link>
                        </li>
                        <li>
                          <Link href="/index-2">Pricing & Plans</Link>
                        </li>
                      </ul>
                      <ul className="list">
                        <li>
                          <Link href="/index-2">Leadrship</Link>
                        </li>
                        <li>
                          <Link href="/index-2">Certificates</Link>
                        </li>
                        <li>
                          <Link href="/index-2">Testimonials</Link>
                        </li>
                        <li>
                          <Link href="/index-2">FAQ’s</Link>
                        </li>
                        <li>
                      ...
                      <ul className="list">
                        ...
                        <li>
                          <Link href="/index-2">News</Link>
                        </li>
                        <li>
                          <Link href="/index-2">Policies</Link>
                        </li>
                        <li>
                          <Link href="/index-2">Monitoring</Link>
                        </li>
                        <li>
                          <Link href="/index-2">Contact Us</Link>
                        </li>
                      </ul>
                    </div>
                  </div>
            ...
            <div className="bottom-inner clearfix">
              <div className="copyright pull-left">
                <p>
                  ...
                  <Link href="/index-2">Blackcats</Link>, All Rights Reserved.
                </p>
              </div>
              <ul className="footer-nav pull-right clearfix">
                ...
                <li>
                  <Link href="/index-2">Site Map</Link>
                </li>
              </ul>
            </div>
          </div>
