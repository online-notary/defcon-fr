        ...
        <header className={`main-header style-four ${scroll ? "fixed-header" : ""}`}>
            ...
            <div className="page-header-mobile-info">
                        ...
                        <div className="auto-container">
                            <div className="top-inner clearfix">
                                <div className="text pull-left">
                                    <h6><i className="icon-right-arrow"></i>Get a Quote: <Link href="/index-4">Estimation Without any fee or oblication</Link></h6>
                                </div>
                                <div className="info clearfix pull-right">
                                    <ul className="social-links clearfix">
                                        ...
                                        <li><Link href="/index-4"><i className="fab fa-linkedin-in"></i></Link></li>
                                    </ul>
                                    <div className="search-box-outer" onClick={handleSidebar}><i className="icon-search"></i><span>Search</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="header-upper-2">
                        <div className="upper-inner clearfix">
                            <div className="logo-box pull-left">
                                <figure className="logo"><Link href="/index-4"><img src="assets/images/logo-5.png" alt=""/></Link></figure>
                            </div>
                            <ul className="info-list clearfix pull-right">
                                <li>
                                    <div className="icon-box"><i className="icon-email-2"></i></div>
                                    <p>Mail Us On</p>
                                    <h5><Link href="mailto:info@example.com">info@example.com</Link></h5>
                                </li>
                                <li>
                                    <div className="icon-box"><i className="icon-placeholder"></i></div>
                                    <p>Location</p>
                ...
                <div className="toggle-box clearfix">
                    ...
                    <figure className="logo pull-right"><Link href="/index-4"><img src="assets/images/logo-5.png" alt=""/></Link></figure>
                </div>
            </div>
                        ...
                        <div className="header-lower">
                            <div className="outer-box clearfix">
                                ...
                                <div className="btn-box">
                                    <Link href="/index-4">Request Demo<i className="fas fa-angle-right"></i></Link>
                                </div>
                            </div>
                        </div>
                    </div>
