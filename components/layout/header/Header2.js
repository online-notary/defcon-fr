            ...
            <div className="page-header-mobile-info">
                <div className={isActive.key == 1 ? "page-header-mobile-info-content current" : "page-header-mobile-info-content"}>
                    <div className="header-top-2">
                        <div className="outer-container">
                            ...
                            <div className="text">
                                <h6><i className="icon-right-arrow"></i>Get a Quote: <Link href="/index-2">Estimation Without any fee or oblication</Link></h6>
                            </div>
                            <div className="right-column">
                                <div className="mail-box"><i className="icon-email-2"></i><Link href="mailto:info@example.com">info@example.com</Link></div>
                ...
                <div className="toggle-box clearfix">
                    ...
                    <div className="btn-box">
                        <Link href="/index-2" className="theme-btn style-one">Request Demo</Link>
                    </div>
                </div>
            </div>
                ...
                <div className="outer-box">
                    <div className="left-column">
                        <div className="logo-box">
                            <figure className="logo"><Link href="/index-2"><img src="assets/images/logo-3.png" alt=""/></Link></figure>
                        </div>
                        <div className="search-box-outer" onClick={handleSidebar}><i className="icon-search"></i></div>
                    </div>
