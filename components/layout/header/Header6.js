...
export default function Header6({ scroll, handleMobileMenu, handleSidebar }) {
    ...
    return (
        ...
        <header className={`main-header style-six ${scroll ? "fixed-header" : ""}`}>

            <div className="logo-box">
                <figure className="logo"><Link href="/index-6"><img src="assets/images/logo-7.png" alt=""/></Link></figure>
            </div>
                    ...
                    <div className="outer-box clearfix">
                        ...
                        <ul className="other-option clearfix pull-right">
                            ...
                            <li className="btn-box">
                                <Link href="/index-6" className="theme-btn">Request Demo</Link>
                            </li>
                        </ul>
                    </div>
                </div>
