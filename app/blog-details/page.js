...
export default function Blog_details() {
    ...
    return (
        <div className="boxed_wrapper">
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Blog Single Post">
                            ...
                            <div className="col-lg-8 col-md-12 col-sm-12 content-side">
                                <div className="blog-details-content">
                                    ...
                                    <div className="upper-block">
                                        ...
                                        <figure className="image-box"><img src="assets/images/news/news-23.jpg" alt=""/></figure>
                                        <div className="text">
                                        ...
                                        <div className="two-column">
                                            <div className="row clearfix">
                                                ...
                                                <div className="col-lg-6 col-md-6 col-sm-12 image-column">
                                                    <figure className="image"><img src="assets/images/news/news-28.jpg" alt=""/></figure>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="text">
                                        ...
                                        <div className="row clearfix">
                                            <div className="col-lg-6 col-md-6 col-sm-12 column">
                                                <div className="single-btn prev-btn">
                                                    <figure className="post-image"><img src="assets/images/news/post-btn-1.jpg" alt=""/></figure>
                                                    <div className="inner">
                                                        <Link href="/blog-details">Prev</Link>
                                                        <h6>How can i Watch CCTV Footage on my Computer?</h6>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="col-lg-6 col-md-6 col-sm-12 column">
                                                <div className="single-btn next-btn">
                                                    <figure className="post-image"><img src="assets/images/news/post-btn-2.jpg" alt=""/></figure>
                                                    <div className="inner">
                                                        <Link href="/blog-details">Next</Link>
                                                        <h6>Should Families get 24/7 Access to Care Home CCTV?</h6>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="comment-box">
                                        ...
                                        <div className="comment">
                                            ...
                                            <div className="comment-inner">
                                                <div className="comment-info clearfix">
                                                    <h4>Isaac Herman</h4>
                                                    <span className="post-date">June 14, 2020 [11.00am]</span>
                                                </div>
                                        ...
                                        <div className="comment reply-comment">
                                            ...
                                            <div className="comment-inner">
                                                <div className="comment-info clearfix">
                                                    <h4>William Cobus</h4>
                                                    <span className="post-date">June 14, 2020 [11.20am]</span>
                                                </div>
                                        ...
                                        <form method="post" action="/blog-details" className="default-form"> 
                                            <div className="row clearfix">
                                                ...
                                                <div className="col-lg-12 col-md-12 col-sm-12 form-group message-btn">
                                                    <button className="theme-btn" type="submit" name="submit-form">post comment</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
