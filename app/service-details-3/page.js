...
export default function Service_details_three() {
    ...
    return (
        <div className="boxed_wrapper">
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Maintenance">
                                    ...
                                    <div className="sidebar-widget category-widget">
                                        ...
                                        <div className="widget-content">
                                            <ul className="category-list clearfix">
                                                ...
                                                <li><Link href="/service-details-3" className="current">Maintenance<i className="icon-checked"></i></Link></li>
