        ...
        <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Meet Our Team">
                  ...
                  <div className="team-block-two">
                    <div className="inner-box">
                      <figure className="image-box">
                        <img
                          src="assets/images/team/John-Catalina.png"
                          alt="John-Catalina"
                      ...
                      <div className="content-box">
                        <div className="share-option">
                          ...
                          <ul className="share-links clearfix">
                            <li>
                              <Link href="https://www.facebook.com/dfwdefconone">
                            ...
                            <li>
                              <Link href="https://www.linkedin.com/company/defcon-one-security-inc./">
                        ...
                        <h4>
                          <Link href="/index-6">John Catalina</Link>
                        </h4>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="team-block-two">
                    <div className="inner-box">
                      ...
                      <div className="content-box">
                        ...
                        <h4>
                          <Link href="/index-6">Peshotan Mehta</Link>
                        </h4>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="team-block-two">
                    <div className="inner-box">
                      ...
                      <div className="content-box">
                        ...
                        <h4>
                          <Link href="/index-6">Peter Fransisco</Link>
                        </h4>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="team-block-two">
                    <div className="inner-box">
                      ...
                      <div className="content-box">
                        ...
                        <h4>
                          <Link href="/index-6">Hendry James</Link>
                        </h4>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="team-block-two">
                    <div className="inner-box">
                      ...
                      <div className="content-box">
                        ...
                        <h4>
                          <Link href="/index-6">Mason Archie</Link>
                        </h4>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="team-block-two">
                    <div className="inner-box">
                      ...
                      <div className="content-box">
                        ...
                        <h4>
                          <Link href="/index-6">Jake Reuben</Link>
                        </h4>
                      </div>
                    </div>
                  </div>
          ...
          <section className="team-section team-page sec-pad">
            ...
            <div className="auto-container">
              <Swiper
                {...swiperOptions}
                className="swiper-container four-item-carousel"
              >
                <SwiperSlide>
                  <div className="team-block-one">
                    <div className="inner-box">
                      ...
                      <div className="lower-content">
                        <h4>
                          <Link href="/index-2">David Luponis</Link>
                        </h4>
                        <span className="designation">Founder</span>
