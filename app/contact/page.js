        ...
        <section className="contact-page-section sec-pad">
          <div className="auto-container">
            <div className="sec-title centred">
              ...
              <h2>
                We’re always here for you to <br />
                give best service
              </h2>
            </div>
            <div className="row clearfix">
              ...
              <div className="col-lg-4 col-md-12 col-sm-12 sidebar-column">
                <div
                  ...
                  style={{
                    backgroundImage:
                      'url(assets/images/resource/contact-1.jpg)',
                  }}
                >
          ...
          <div className="auto-container">
            <div className="inner-content clearfix">
              ...
              <div className="single-item">
                ...
                <h4>Call Us</h4>
                <p>
                  Sales: <Link href="tel:5001234567">+500 123 4567</Link>
                  <br />
                  Toll Free: <Link href="tel:18000001234">+1800-000-1234</Link>
                </p>
              </div>
              <div className="single-item">
                <div className="icon-box">
