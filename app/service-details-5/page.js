  ...
  return (
    <div className="boxed_wrapper">
      <Layout
        headerStyle={1}
        footerStyle={1}
        breadcrumbTitle="Video Surveillence"
      >
                ...
                <div className="service-sidebar default-sidebar">
                      ...
                      <ul className="category-list clearfix">
                        <li>
                          <Link href="/service-details">
                            Install & Configure<i className="icon-checked"></i>
                          </Link>
                        </li>
                        <li>
                          <Link href="/service-details-2">
                            Repair & Service<i className="icon-checked"></i>
                          </Link>
                        </li>
                        <li>
                          <Link href="/service-details-3">
                            Maintenance<i className="icon-checked"></i>
                          </Link>
                        </li>
                        <li>
                          <Link href="/service-details-4">
                            Video Verification<i className="icon-checked"></i>
                          </Link>
                        </li>
                        <li>
                          <Link href="/service-details-5" className="current">
                            Video Surveillence<i className="icon-checked"></i>
                          </Link>
                        </li>
                        <li>
                          <Link href="/service-details-6">
                            Interactive Security<i className="icon-checked"></i>
                          </Link>
                        </li>
                      </ul>
                    </div>
                  ...
                  <div className="support-widget centred">
                    <div
                      ...
                      style={{
                        backgroundImage:
                          'url(assets/images/resource/widget-1.jpg)',
                      }}
                    >
                      <div className="content-box">
                        <div className="icon-box">
                          ...
                          <div
                            ...
                            style={{
                              backgroundImage:
                                'url(assets/images/icons/icon-bg.png)',
                            }}
                          ></div>
                        </div>
                        ...
                        <Link href="tel:18001234567">
                          <i className="icon-phone-call"></i>1(972) 449-4130
                        </Link>
                      </div>
                    </div>
                  </div>
                  <div className="sidebar-widget download-widget">
                    ...
                    <ul className="download-list clearfix">
                      <li>
                        <Link href="/service-details">
                          <i className="icon-down-arrow"></i>Company Profile
                          <span>pdf</span>
                        </Link>
                      </li>
                      <li>
                        <Link href="/service-details">
                          <i className="icon-down-arrow"></i>Service Details
                          <span>Doc</span>
                        </Link>
                      </li>
                    </ul>
                ...
                <div className="service-details-content">
                  <div className="content-one">
                    <figure className="image-box">
                      <img src="assets/images/service/service-16.jpg" alt="" />
                    </figure>
                    <div className="text">
                      ...
                      <p>
                        ...
                        dislikes, or avoids pleasure itself, but because those
                      ...
                      <div className="row clearfix">
                        <div className="col-lg-6 col-md-6 col-sm-12 text-column">
                          <div className="text">
                            ...
                            <p>
                              Laborious physical exercise, except too obtain
                      ...
                      <div className="row clearfix">
                        ...
                        <div className="col-lg-6 col-md-6 col-sm-12 text-column">
                          <div className="text">
                            ...
                            <p>
                              Our power of choice is when nothing all prevents
                              our being able.
                            </p>
                            <ul className="list clearfix">
                  ...
                  <div className="content-three">
                    <div className="text">
                      ...
                      <p>
                        Denouncing pleasure and praising pain was born and will
                        give you a complete account of the system expound actual
